...
```md filename="app/.../link.mdx"
---
title: next/link
description: API reference for the next/link component.
---
...
{/_ DO NOT EDIT THIS PAGE. _/}
{/_ The content of this page is pulled from the source above. _/}
```
